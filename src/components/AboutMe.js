        ...
        <div className="container-lg" style={{ paddingTop: "2rem" }}>
          ...
          <div data-aos="fade-right" className="container-lg">
            <p>
              ...
              <br />
              除此之外，我也會創建其他網頁全端的作品。
              對於下一個作品已有一個初步構想，我想創造一個為喜愛下廚的人提供便利的網站。
              這個網站的特點是，透過現有的食材進行查詢，系統將計算出根據當前食材的可行性，
              並列出可行性大於60%的料理方案。對於選擇的料理可行性不足80%的情況，系統將提供替代的食材選項，以增加料理的成功率。
              <br />
              <br />
              我認為工程師的實力主要來自於實際的工作經驗，即使我無法參加AppWork，我仍會持續努力朝著上面所提到的方向前進。
              當我累積足夠的學習經驗後，我會開始尋找後端開發實習生的工作機會，希望能夠在相關領域
              透過實際工作的挑戰與鍛鍊，將自己從初學者提升到初階工程師的水平。
              <br />
              <br />
